...
<template>
  <div>
    ...
    <div class="search-terms-holder">
      ...
      <div class="search-terms-limit">
        <div class="search-terms-title">LIMIT RESULTS</div>
        <select v-model="limit" class="limit-sel">
    ...
    <div v-if="meta" class="search-meta-holder">
      <div v-if="times.length === meta.limit" class="max-results mb-1">Search limited to {{ meta.limit }} results.</div>
